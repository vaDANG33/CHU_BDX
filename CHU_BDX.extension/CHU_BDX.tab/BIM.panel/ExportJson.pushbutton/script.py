...
if __name__ == "__main__":
    ...
    parameters_selected = ["Numéro","Niveau"]
    ...
    components = [
              ...
              ComboBox('user_file_export', {"geojson & topojson" : "both", 'topojson': "topo", "geojson" : "geo" }, default="topojson" ),
    ...
    rooms_in_phase = [r for r in all_rooms if r.get_Parameter(BuiltInParameter.ROOM_PHASE).AsElementId() == first_phase.Id]
    all_rooms_placed = [room for room in rooms_in_phase if room.Area != 0]
